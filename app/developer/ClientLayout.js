      ...
      >
        ...
        <div className="flex flex-col items-center space-y-4 relative z-10">
          ...
          <div className="text-center">
            <h2 className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Developer</h2>
              ...
              <Dialog.Panel className="w-full max-w-sm rounded-2xl bg-white p-0 shadow-2xl mx-auto relative">
                <div className="flex flex-col items-center p-8">
                  ...
                  <div className="flex justify-end space-x-4 w-full mt-2">
                    ...
                    <button 
                      onClick={() => { handleLogout(); setLogoutOpen(false); }} 

...
export default function AdminListIssue() {
  ...
  }, [mounted, pageNumber, pageSize, sortBy, orderBy]);
  ...
  useEffect(() => {
    ...
    axios.get('http://127.0.0.1:8000/api/user-dev-ddl')
      ...
      .catch(err => console.error('Failed to fetch developer list:', err));
  }, []);
  ...
  const fetchIssues = async () => {
    ...
    try {
      const res = await axios.post(
        'http://127.0.0.1:8000/api/get-all-transactions',
        {
          search: searchTerm,
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={() => router.push('/admin/create-issue')}
                ...
                <tr key={issue.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    ...
                    <button
                      ...
                      onClick={() => router.push(`/admin/edit-issue?id=${issue.id}&issueid=${issue.issueid}`)}
                    >
                      Edit
                    </button>
                  </td>
